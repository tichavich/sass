...
- [core.md](.agents/skills/scss/core.md) - Token system, HSL colors, cascade layers
- [tokens.md](.agents/skills/scss/tokens.md) - Spacing and typography systems
- [theming.md](.agents/skills/scss/theming.md) - Dark mode implementation
- [patterns.md](.agents/skills/scss/patterns.md) - Module structure, data-attributes, mixins, global styles, icons
- [cva.md](.agents/skills/scss/cva.md) - cva integration with SCSS Modules
- [advanced.md](.agents/skills/scss/advanced.md) - :has(), :global(), nesting patterns
- [modules.md](.agents/skills/scss/modules.md) - Sass module system (@use and @forward)
- [reference.md](.agents/skills/scss/reference.md) - Decision frameworks and anti-patterns
...
For complete implementation examples, see [core.md](.agents/skills/scss/core.md#pattern-1-two-tier-token-system).
...
For complete implementation examples, see [core.md](.agents/skills/scss/core.md#pattern-2-hsl-color-format-with-css-color-functions).
...
For complete implementation examples, see [core.md](.agents/skills/scss/core.md#pattern-3-css-cascade-layers-for-predictable-precedence).
...
For complete implementation examples, see [theming.md](.agents/skills/scss/theming.md#pattern-4-dark-mode-with-dark-class-and-mixin).
...
- **Pattern 5:** SCSS Module Structure with Cascade Layers - [patterns.md](.agents/skills/scss/patterns.md#pattern-5-scss-module-structure-with-cascade-layers)
- **Pattern 6:** Spacing System with Semantic Tokens - [tokens.md](.agents/skills/scss/tokens.md#pattern-6-spacing-system-with-semantic-tokens)
- **Pattern 7:** Typography System with REM-Based Sizing - [tokens.md](.agents/skills/scss/tokens.md#pattern-7-typography-system-with-rem-based-sizing)
- **Pattern 8:** Data-Attributes for State Styling - [patterns.md](.agents/skills/scss/patterns.md#pattern-8-data-attributes-for-state-styling)
- **Pattern 9:** SCSS Mixins for Reusable Patterns - [patterns.md](.agents/skills/scss/patterns.md#pattern-9-scss-mixins-for-reusable-patterns)
- **Pattern 10:** Global Styles Organization - [patterns.md](.agents/skills/scss/patterns.md#pattern-10-global-styles-organization)
- **Pattern 11:** Icon Styling - [patterns.md](.agents/skills/scss/patterns.md#pattern-11-icon-styling)
- **Pattern 12:** cva Integration - [cva.md](.agents/skills/scss/cva.md#pattern-12-cva-class-variance-authority-integration)
- **Pattern 13:** Advanced CSS Features - [advanced.md](.agents/skills/scss/advanced.md#pattern-13-advanced-css-features)
- **Pattern 14:** Sass Module System (@use and @forward) - [modules.md](.agents/skills/scss/modules.md#pattern-14-sass-module-system-use-and-forward)
...
For complete anti-patterns and red flags, see [reference.md](.agents/skills/scss/reference.md).
